...
const users = [
  {
    ...
    country: 'Россия',
    daw: [daws.ableton],
    style: [styles.trance, styles.progressive],
  ...
  },
  {
    ...
    country: 'Australia',
    daw: [daws.studioOne],
    style: [styles.house, styles.progressive],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'USA',
    daw: [daws.cubase],
    style: [styles.melodicTechno, styles.progressive],
  ...
  },
  {
    ...
    style: [styles.techno, styles.industrial],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'Netherlands',
    daw: [daws.ableton],
    style: [styles.house, styles.edm],
    workFormat: [styles.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    style: [styles.bassHouse, styles.futureBass, styles.dnb],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'Россия',
    daw: [daws.studioOne],
    style: [styles.melodicTechno, styles.midtempo],
    workFormat: [formats.collaboration],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  ...
  },
  {
    ...
    country: 'Украина',
    daw: [daws.fl],
    style: [styles.trance, styles.edm],
    workFormat: [formats.collaboration],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    style: [styles.ambient, styles.chillout],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'Kazakhstan',
    daw: [daws.ableton, daws.bitwig],
    style: [styles.bassHouse, styles.futureBass, styles.techno],
    workFormat: [formats.collaboration],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  ...
  },
  {
    ...
    country: 'India',
    daw: [daws.ableton],
    style: [styles.house, styles.organic],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'Россия',
    daw: [daws.fl],
    style: [styles.edm, styles.futureBass],
    workFormat: [formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  ...
  },
  {
    ...
    country: 'Iceland',
    daw: [daws.studioOne],
    style: [styles.ambient, styles.melodicTechno, styles.loFi],
    workFormat: [formats.collaboration],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    country: 'Venezuela',
    daw: [daws.bitwig],
    style: [styles.dnb, styles.futureBass, styles.dubstep],
    workFormat: [formats.collaboration, formats.remix],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
  {
    ...
    style: [styles.trance, styles.techno, styles.melodicTechno],
    workFormat: [formats.collaboration],
    soundCloud: 'https://soundcloud.com/',
    bookmark: false,
  },
